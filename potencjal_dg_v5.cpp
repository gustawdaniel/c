...
struct nazwa
{
string ma;//macierz przed diagonalizacją
string mr;//macierz po diagonalizacji
string pq;//seria p,q,t
string p, q;//pojedyńcze dla p i q od czasu t
};
...
//zostały przeniesione do części obliczeniowej ponieważ dopiero tam 
//nastepuje inicjalizacja nazw plików, to znaczy tam wiadomo 
//jaki rodzaj obliczeń będzie wykonywany
...
//nazwy plików
void ininazwa(nazwa &na, bool unum)
{
   if(unum ==0)//analityczny
   {
      na.ma="A_dg_ana.txt";
      na.mr="R_dg_ana.txt";
      na.pq="PQ_dg_ana.txt";      
...
//  ininazwa(na, unum);
  fstream pplk, qplk;
   ...
   if(unum ==0)//analityczny
   {
pplk.open("P_dg_ana.txt", ios::out );
qplk.open( "Q_dg_ana.txt", ios::out );
a.plik.open("PQ_dg_ana.txt", ios::out );      
   }
   if(unum ==1)//spline
   {
pplk.open("P_dg_spl.txt", ios::out );
qplk.open( "Q_dg_spl.txt", ios::out );
a.plik.open("PQ_dg_spl.txt", ios::out );     
   }
...
void k(string p)
{
  ...
  if(p=="wstep")
  {
    cout<< "Program: 'potencjal_dg_v5.cpp'"<<endl;
    cout<< "Autor: Daniel Gustaw "<<endl;
    cout<< "Data: 26.01.2012"<<endl;
  }
  if(p=="ana")
  {
    cout <<endl;
    cout<< "Wyniki dla ";
    cout<<"analitycznego"; cout<<" potencjalu:"<<endl;
  }
  if(p=="spl") 
  { 
    cout <<endl;
...
//nazwa na;
   ...
   obliczenia(a,s,0);//potencjał zwykły

   k("ana");
  cout << " Okres T = "<< a.T<<endl;
  cout << " Całki P = " << a.cP << "    Q = " <<a.cQ <<endl;
  cout << "Utworzono plik o nazwie 'PQ_dg_ana.txt'"<<endl;
  ...
  cout << " Okres T = "<< a.T<<endl;
  cout << " Całki P = " << a.cP << "    Q = " <<a.cQ <<endl;
  cout << "Utworzono plik o nazwie 'PQ_dg_spl.txt'"<<endl;
